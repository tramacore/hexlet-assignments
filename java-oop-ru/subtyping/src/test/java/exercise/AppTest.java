...
class AppTest {
    ...
    @Test
    void testInMemory() {
        Map<String, String> example = new HashMap<>(Map.of("test", "sample",
                "12", "text"));

        KeyValueStorage keyValueStorage = new InMemoryKV(example);
        keyValueStorage.set("test", "popa");
        System.out.print(keyValueStorage.toMap());
    }
}
